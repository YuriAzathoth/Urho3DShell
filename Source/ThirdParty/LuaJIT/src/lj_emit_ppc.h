...
static void emit_rot(ASMState* as, PPCIns pi, Reg ra, Reg rs, int32_t n, int32_t b, int32_t e)
{
	*--as->mcp = pi | PPCF_T(rs) | PPCF_A(ra) | PPCF_B(n) | PPCF_MB(b) | PPCF_ME(e);
}
...
#define emit_loadn(as, r, tv) emit_lsptr(as, PPCI_LFD, ((r)&31), (void*)(tv), RSET_GPR)
...
static void emit_call(ASMState* as, void* target)
{
	...
	{ /* Target out of range: need indirect call. Don't use arg reg. */
