...
#define RSET_GPREVEN                                                                                                   \
	(RID2RSET(RID_R0) | RID2RSET(RID_R2) | RID2RSET(RID_R4) | RID2RSET(RID_R6) | RID2RSET(RID_R8) | RID2RSET(RID_R10))
#define RSET_GPRODD                                                                                                    \
	(RID2RSET(RID_R1) | RID2RSET(RID_R3) | RID2RSET(RID_R5) | RID2RSET(RID_R7) | RID2RSET(RID_R9) | RID2RSET(RID_R11))
#if LJ_SOFTFP
#define RSET_FPR 0
#else
