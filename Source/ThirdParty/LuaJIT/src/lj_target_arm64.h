...
#define GPRDEF(_)                                                                                                      \
	...
	_(X12)                                                                                                             \
	_(X13)                                                                                                             \
	_(X14) _(X15) _(X16) _(X17) _(X18) _(X19) _(X20) _(X21) _(X22) _(X23) _(X24) _(X25) _(X26) _(X27) _(X28) _(FP)     \
		_(LR) _(SP)
#define FPRDEF(_)                                                                                                      \
	_(D0)                                                                                                              \
	_(D1)                                                                                                              \
	...
	_(D12)                                                                                                             \
	_(D13)                                                                                                             \
	_(D14) _(D15) _(D16) _(D17) _(D18) _(D19) _(D20) _(D21) _(D22) _(D23) _(D24) _(D25) _(D26) _(D27) _(D28) _(D29)    \
		_(D30) _(D31)
#define VRIDDEF(_)
