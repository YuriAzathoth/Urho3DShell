...
#elif defined(__ppc__) || defined(__ppc) || defined(__PPC__) || defined(__PPC) || defined(__powerpc__) ||              \
	defined(__powerpc) || defined(__POWERPC__) || defined(__POWERPC) || defined(_M_PPC)
...
#endif
#if LJ_ARCH_NUMMODE == LJ_NUMMODE_DUAL || (LJ_ARCH_NUMMODE == LJ_NUMMODE_DUAL_SINGLE && LUAJIT_NUMMODE != 1) ||        \
