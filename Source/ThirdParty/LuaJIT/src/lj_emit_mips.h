...
#define emit_loadn(as, r, tv) emit_lsptr(as, MIPSI_LDC1, ((r)&31), (void*)(tv), RSET_GPR)

/* Get/set global_State fields. */
static void emit_lsglptr(ASMState* as, MIPSIns mi, Reg r, int32_t ofs) { emit_tsi(as, mi, r, RID_JGL, ofs - 32768); }

#define emit_getgl(as, r, field) emit_lsglptr(as, MIPSI_LW, (r), (int32_t)offsetof(global_State, field))
#define emit_setgl(as, r, field) emit_lsglptr(as, MIPSI_SW, (r), (int32_t)offsetof(global_State, field))
...
static void emit_call(ASMState* as, void* target, int needcfa)
{
	...
	*--p = MIPSI_NOP;
	...
	{ /* Target out of range: need indirect call. */
