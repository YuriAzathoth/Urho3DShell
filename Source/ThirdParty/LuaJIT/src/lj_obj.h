...
#define proto_kgc(pt, idx)                                                                                             \
	check_exp((uintptr_t)(intptr_t)(idx) >= (uintptr_t) - (intptr_t)(pt)->sizekgc, gcref(mref((pt)->k, GCRef)[(idx)]))
...
#define tvchecklive(L, o)                                                                                              \
	UNUSED(L), lua_assert(!tvisgcv(o) || ((~itype(o) == gcval(o)->gch.gct) && !isdead(G(L), gcval(o))))
