...
#define IRTDEF(_)                                                                                                      \
	...
	_(THREAD, 4)                                                                                                       \
	_(PROTO, 4)                                                                                                        \
	_(FUNC, 4) _(P64, 8) _(CDATA, 4) _(TAB, 4) _(UDATA, 4) _(FLOAT, 4) _(NUM, 8) _(I8, 1) _(U8, 1) _(I16, 2) _(U16, 2) \
		_(INT, 4) _(U32, 4) _(I64, 8) _(U64, 8) _(SOFTFP, 4) /* There is room for 9 more types. */
...
#if LJ_GC64
#define IRT_IS64                                                                                                       \
	((1u << IRT_NUM) | (1u << IRT_I64) | (1u << IRT_U64) | (1u << IRT_P64) | (1u << IRT_LIGHTUD) | (1u << IRT_STR) |   \
	 (1u << IRT_THREAD) | (1u << IRT_PROTO) | (1u << IRT_FUNC) | (1u << IRT_CDATA) | (1u << IRT_TAB) |                 \
	 (1u << IRT_UDATA))
#elif LJ_64
...
#define ir_k64(ir) check_exp((ir)->o == IR_KNUM || (ir)->o == IR_KINT64, mref((ir)->ptr, cTValue))
#define ir_kptr(ir) check_exp((ir)->o == IR_KPTR || (ir)->o == IR_KKPTR, mref((ir)->ptr, void))
